  ...
  return (
    <div className='bgpart relative w-[87vw] rounded-3xl z-0 flex flex-col justify-center items-center gap-y-12 md:gap-y-8 py-8 md:py-16 '>
        ...
        <div className='text-center -pt-4 gapy-y-4 md:gap-y-6 text-white flex flex-col items-center  '>
            <p className='p-4 sm:p-0 text-[2rem] sm:text-[3rem] font-primary font-bold max-w-[550px]   leading-[125%]    text-white'>Everything in your Whimsical Workspace is connected</p>
            <p className='md:text-[16px] text-[14px]  max-w-[540px] px-4 font-secondary'>Simply type @ to link a file, task, or teammate anywhere in Whimsical. You can even display links as embeds, making important context more visual and easier to understand.</p>
        </div>
